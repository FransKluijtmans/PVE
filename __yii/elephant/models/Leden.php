...
class Leden extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('personeelsnummer, aanhef, voorletters, achternaam, voorvoegsel, emailAdres, rekeningNummer, straat, huisNummer, toevoeging, postcode, plaats, telefoonNummer, geboorteDag, geboorteMaand, geboorteJaar, datumGewijzigd, statusAanmelding, afdeling, redenLid, werkendLid, ledenFunctie, datumAangemaakt, datumAangepast, userAangemaakt, userAangepast, groepens', 'safe', 'on'=>'search'),
		);
	}
    ...
    {
    	if($this->scenario == 'createLeden' || $this->scenario == 'updateLeden'){
