<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'locatie',array('class'=>'span5','maxlength'=>45)); ?>

	<?php echo $form->textFieldRow($model,'title',array('class'=>'span5','maxlength'=>45)); ?>

	<?php echo $form->textFieldRow($model,'alt',array('class'=>'span5','maxlength'=>45)); ?>
	...
	<?php echo $form->textFieldRow($model,'tbl_media_types_mediaTypesId',array('class'=>'span5')); ?>
