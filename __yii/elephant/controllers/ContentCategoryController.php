...
class ContentCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ContentCategory']))
		{
			...
			if($model->save())
				Yii::app()->user->setFlash('success', '<strong>Goed gedaan!</strong> Groep '.$model->omschrijving.' is succesvol aangemaakt.');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['ContentCategory']))
		{
			...
			if($model->save())
				Yii::app()->user->setFlash('success', '<strong>Goed gedaan!</strong> Administrator '.$model->omschrijving.' is succesvol aangepast.');
				$this->redirect(array('view','id'=>$model->id));
		}
