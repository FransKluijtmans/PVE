...
class AdminController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','generatePassword','create','update','admin','delete'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Admin']))
		{
			...
			if($model->save()){
				Yii::app()->user->setFlash('success', '<strong>Goed gedaan!</strong> Administrator '.$model->ledenPersoneelsnummer->achternaam.' is succesvol aangemaakt.');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Admin']))
		{
			$model->attributes=$_POST['Admin'];
			if($model->save()){
				Yii::app()->user->setFlash('success', '<strong>Goed gedaan!</strong> Administrator '.$model->ledenPersoneelsnummer->achternaam.' is succesvol aangepast.');
				$this->redirect(array('view','id'=>$model->id));
			}
		}
		Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/jquery.passwordStrenghCheck.js',CClientScript::POS_END);
	...
	public function actionGeneratePassword($length = 8) {
