...
class ContentController extends Controller
{
	...
	{
		$this->pageTitle=  'Maken artikel - ' . Yii::app()->name;
		$model=new Content;
		...
		if(isset($_POST['Content']))
		{
			...
			$model->contentCategories=$_POST['Content']['contentCategories'];
	...
	{
		$this->pageTitle=  'Aanpassen artikel - ' . Yii::app()->name;
		$model=$this->loadModel($id);
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);
	...
	{
		$this->pageTitle=  'Artikelen overzicht - ' . Yii::app()->name;
